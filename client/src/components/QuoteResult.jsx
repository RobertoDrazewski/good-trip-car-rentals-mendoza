      ...
      {!confirmado ? (
        <div className="bg-white p-5 sm:p-10 md:p-14 rounded-[2rem] sm:rounded-[4rem] shadow-2xl border-2 border-slate-100 text-slate-900 w-full">
          ...
          <h3 className="text-2xl sm:text-3xl font-black uppercase italic text-center text-slate-900 mb-2 tracking-tight">
            {t('resumen_titulo_1', 'Tu Resumen de')} <span className="text-yellow-500">{t('resumen_titulo_2', 'Viaje')}</span>
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 w-full">
            ...
            <div className={itemEstilo}>
              ...
              <div className="min-w-0 flex-1">
                ...
                <h4 className="text-xs sm:text-sm font-black uppercase italic text-slate-900 mt-0.5 truncate">{formatLocationLabel(entrega)}</h4>
            ...
            <div className={itemEstilo}>
              ...
              <div className="min-w-0 flex-1">
                ...
                <h4 className="text-xs sm:text-sm font-black uppercase italic text-slate-900 mt-0.5 truncate">{formatLocationLabel(devolucion)}</h4>
            ...
            <div className={`${itemEstilo} md:col-span-2 border-l-4 border-l-blue-500 bg-blue-50/40`}>
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[8px] sm:text-[9px] font-black uppercase tracking-widest text-blue-600">{t('label_garantia', 'Garantía Reembolsable')}</p>
            ...
            <div className={`${itemEstilo} md:col-span-2 border-l-4 border-l-emerald-500 bg-emerald-50/30`}>
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-[11px] sm:text-xs font-black uppercase text-slate-800 mt-0.5">{t('pet_friendly_tag', '¡Tu Caniche o mascota viaja con vos!')}</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 sm:mt-8 bg-slate-900 p-5 sm:p-8 rounded-[1.5rem] sm:rounded-[2.5rem] shadow-xl relative overflow-hidden text-center w-full">
            <p className="text-[9px] sm:text-[10px] font-black uppercase text-yellow-500 tracking-[0.2em] sm:tracking-[0.3em] mb-1.5">{t('total_entrega', 'VALOR TOTAL A ENTREGAR AL RECIBIR')}</p>
